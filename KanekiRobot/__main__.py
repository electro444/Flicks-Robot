...
PM_START_TEXT = """
`Hi, I Am A Group Manager Bot 👑`
`Crated By` [POKECHU FF](https://t.me/POKECHU_FF)
"""

buttons = [
        [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/PF_GROUP_MANAGER_BOT?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
            text="ᴄʜᴀɴɴᴇʟ ɪɴғᴏ", url=f"https://t.me/pffamilyff"
        ),
    ],
    [
        InlineKeyboardButton(text="ɢʀᴏᴜᴘ sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/pfsupportff"),
        InlineKeyboardButton(
            text="ᴄʀᴇᴀᴛᴏʀ", url=f"https://t.me/POKECHU_FF"
        ),
    ],
    [
...
Kaneki_IMG = "https://telegra.ph/file/684d96aa8fafd645a9375.jpg"

DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project [POKECHU FF](t.me/POKECHU_FF) \
