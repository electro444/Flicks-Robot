...
`Crated By` [ELECTRO 444](https://t.me/ELECTRO_444)
"""

buttons = [
        [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/EO_GROUP_MANAGER_BOT?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
            text="ᴄʜᴀɴɴᴇʟ ɪɴғᴏ", url=f"https://t.me/eoinfoff"
        ),
    ],
    [
